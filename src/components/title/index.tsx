...
const Title: React.FC<titleTypes>= ({number, text}) => {
    return (
        <div className=' w-full font-barlowCondensed  mt-4  justify-center md:justify-start  md:w-[40%] xl:w-[30%]  md:ml-12 lg:ml-0 md:mt-12 lg:mt-24 flex items-center xl:justify-end gap-7'>
