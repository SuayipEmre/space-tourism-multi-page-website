...
const Home = () => {
  ...
  return (
    <div className=' min-h-screen' id='home_screen_container'>
           <Header />
      <div className=' h-full flex items-center justify-center'>
        ...
        <div className=' w-full  gap-24 lg:gap-0 lg:w-[90%]  flex flex-col lg:flex-row items-center justify-between'>
          ...
          <div className=' w-full px-6 md:px-0  md:w-[60%] lg:w-[40%]  flex flex-col items-center md:items-start  gap-6'>
            ...
            <p className='text-[80px] md:text-[150px] tracking-widest text-white font-belleFair '>SPACE</p>
          ...
          <div className='w-[150px] h-[150px] md:w-[242px] md:h-[242px] lg:w-[274px] lg:h-[274px] bg-white rounded-full flex items-center justify-center'>
            <p className='text-[32px] font-belleFair'>EXPLORE</p>
          </div>
